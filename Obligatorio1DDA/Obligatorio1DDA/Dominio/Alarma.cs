...
namespace Obligatorio1DDA.Dominio
{
    class Alarma
    {
        ...
        public Alarma(int cantNegativos, int cantPositivos, int tiempoMaxEnDias, int tiempoMaximoEnMinutos, string informacion, Entidad entidad, int ID)
        {
